...
1. **断线重连** - 玩家断线后无法重新连接到游戏（用户体验问题）
2. **房间管理** - 缺少房间列表，需要手动输入房间号
3. **错误提示** - 验证失败时只在控制台显示，需要UI提示

## 🎉 最近更新

### 2025-11-23
- ✅ **服务器端牌型验证** - 验证牌权、牌型、管牌规则，防止作弊
- ✅ **代码清理** - 删除约758行未使用代码，简化项目结构
- ✅ 出牌卡住问题 - 修复了决策未被正确消费的问题
- ✅ 过牌卡住问题 - 添加 hasSubmitted 标志区分"未决策"和"决策为过牌"
- ✅ 完整游戏流程 - 现在可以从准备到游戏结束完整体验
